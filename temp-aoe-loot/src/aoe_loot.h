...
struct AOELootConfig
{
    ...
    uint32 maxQuality = 1; // 0=Poor(grey), 1=Common(white), 2=Uncommon(green), etc.
    ...
    void Load()
    {
        ...
        maxQuality = sConfigMgr->GetOption<uint32>("AOELoot.MaxQuality", 1);
        ...
        if (maxQuality > 6) maxQuality = 6; // Max is Artifact quality
    }
};
